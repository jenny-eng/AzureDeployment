...
def predict():
    ...
    return render_template('home.html', prediction_text="Predictd Truck Number for Aichi is {}".format(math.floor(prediction[0])))
...
def predict_api():
    ...
    prediction = [np.array(list(data.values()))]
    #output = prediction[0]
